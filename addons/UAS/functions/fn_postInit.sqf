...
if (UAS_option_enableCough || UAS_option_enableSigh || UAS_option_enableWhistle) then {
	...
	[_unitStateMachine,"Manifest","Standby",{true},{_this call UAS_fnc_manifestUnit;},"Return"] call CBA_statemachine_fnc_addTransition;
};
...
if (UAS_option_enableRadio) then {
	...
	// Manifest transitions
	[_groupStateMachine,"Manifest","Standby",{true},{_this call UAS_fnc_manifestGroup;},"Return"] call CBA_statemachine_fnc_addTransition;
};

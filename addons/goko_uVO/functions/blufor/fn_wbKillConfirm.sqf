/*
	...
	description: kill confirm, blufor. Code passes on 'instigator' via remote exec, gets global from here
*/
params ["_unit", "_instigator"];
/*	look for West side base class. */
_searchFriendly = _instigator nearEntities [["SoldierWB"], 50];
...
_null = _this spawn {
	...
	{
		_soundSample = selectRandom [
			"bsupptarget01", "bsupptarget02", "bsupptarget03", "bsupptarget04", "bsupptarget05", "bsupptarget06", 
			"bsupptarget07", "bsupptarget08", "bsupptarget09", "bsupptarget10", "bsupptarget11", "bsupptarget12", "bsupptarget13"
		];
